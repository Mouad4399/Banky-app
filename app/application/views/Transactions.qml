            ...
            ColumnLayout{
                ...
                RowLayout{
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            EmptyField_ {
                                ...
                                borderWidth: 0
                                placeholderText: qsTranslate('', 'Search for a transaction ... ')
                                onTextChanged: {
                    ...
                    Row{
                        ...
                        Repeater{
                            Layout.alignment:Qt.AlignCenter
                            model:['Sent','Received','Sent Requests','Received Requests','All']
                            delegate:Button_ {
                                ...
                                onCheckedChanged:{
                                    if(checked){
                                        transaction_table.transaction_request={
                                            'type':['sent','received','sent_requests','received_requests','all'][index]
                                        }
